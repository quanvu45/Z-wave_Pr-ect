...
typedef enum EVENT_APP_POWER_STRIP
{
  ...
  EVENT_APP_OUTLET1_TOGGLE,
  EVENT_APP_OUTLET2_TOGGLE,
  EVENT_APP_OUTLET3_TOGGLE,
  EVENT_APP_OUTLET2_DIMMER_SHORT_PRESS,
  EVENT_APP_OUTLET2_DIMMER_HOLD,
  EVENT_APP_OUTLET2_DIMMER_RELEASE,
  EVENT_APP_NOTIFICATION_TOGGLE,
}
EVENT_APP;
