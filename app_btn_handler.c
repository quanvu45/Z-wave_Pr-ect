...
void app_button_press_btn_2_handler(uint8_t duration)
{
  uint8_t app_event = EVENT_EMPTY;
...
void app_button_press_btn_3_handler(uint8_t duration)
{
  uint8_t app_event = EVENT_EMPTY;
  ...
  switch (duration) {
    case APP_BUTTON_PRESS_DURATION_SHORT:
      ...
      break;
    case APP_BUTTON_PRESS_DURATION_MEDIUM:
      app_event = EVENT_APP_OUTLET2_TOGGLE;
      break;
    default:
      break;
  }
...
void app_button_press_btn_4_handler(uint8_t duration)
{
  uint8_t app_event = EVENT_EMPTY;
  ...
  switch (duration) {
    case APP_BUTTON_PRESS_DURATION_SHORT:
      ...
      break;
    case APP_BUTTON_PRESS_DURATION_MEDIUM:
      app_event = EVENT_APP_OUTLET3_TOGGLE;
      break;
    default:
      break;
  }
